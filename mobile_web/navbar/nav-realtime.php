...
<div class="header">
            <div id="page-content-wrapper">
                <nav class="navbar navbar-dark bg-success fix-header ">
                    ...
                    <button class="navbar-toggler navbar-color btn-sm" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="form-row p-3" style="height : 5vh">
                            ...
                            <div class="form-group col ">
                                <input class="form-control form-control-sm" type="text" id="sc" name="sc" onkeyup="keySearch()" placeholder="ทะเบียนรถ">
                            </div>
                        </div>
                        <br />
                        <!-- header table  -->
