            ...
            success: function(result) {
                ...
                if (obj != '') {
                    ...
                    $.each(obj, function(key, val) {
                        ...
                        tr = tr + "<td id='" + val[""] + "' onclick='myPanto(" + val["devi_id"] +
                            "," + val["lat"] + "," + val["lng"] + ")' style=cursor:pointer; >" + val["name"] + "</td>";
    ...
    function dataRealtime(Data) {
        ...
        if (!markers.hasOwnProperty(dataArr['id'])) {
            ...
            markerX[dataArr['id']].previousLatLngs.push(markerX[dataArr['id']].getLatLng());
